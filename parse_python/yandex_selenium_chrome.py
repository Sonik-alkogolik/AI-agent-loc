#!/usr/bin/env python3
"""
Yandex Parser через Selenium - с правильным путём к Chrome
...
class YandexSeleniumParser:
    ...
    def setup_driver(self):
        ...
        print(f"✅ Chrome: {self.chrome_path}")
        ...
        for driver_path in driver_paths:
            try:
                ...
                print(f"⚠️ {driver_path}: {e}")
                continue
        
        # Если не нашли chromedriver, пробуем без указания пути
        print("💡 ChromeDriver не найден, пробуем автоматический поиск...")
        try:
            ...
            print("   Откройте Chrome → Настройки → О браузере Chrome")
            print("\n2. Скачайте ChromeDriver:")
            print("   https://chromedriver.chromium.org/downloads")
            print("\n3. Положите chromedriver.exe в одну из папок:")
